...
<head>
    ...
    <link href="../../public/CSS/customer-reg.css" rel="stylesheet" type="text/css" >
    ...
    <div class="loginbg">
        ...
        <div class="login-box">
                ...
                <form action="register-submit.php" method="post"> 
                    ...
                    <p>Already have an account? <a href="../../public/includes/login.php" style="color:blue;font-weight:bold">Sign in</a>.</p>
                </form>    
