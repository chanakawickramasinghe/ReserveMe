		...
		<div class="column1">
			<?php 
					...
					while($rowProduct  = mysqli_fetch_assoc($resultProduct)){  
						echo"<img id=\"featured\" class=\"thumbnail active\" src= \"../../../public/images/restaurant/{$rowProduct['res_id']}/floorplan/1.jpeg\">";
					}
			?>
				...
				<div id="slider">
					<?php 						
							...
							while($rowProduct  = mysqli_fetch_assoc($resultMenu)){  
								echo"<img class=\"thumbnail\" src= \"../../../public/images/restaurant/{$rowProduct['res_id']}/floorplan/{$rowProduct['floorplan_id']}.jpeg\">";
							}						  
					?>					
				</div>
