...
<body>
	...
	<section class="reservation">
		...
		<div class="reservation-text">
			...
			<button type="button" class="hero-button" onclick="location.href='logged_hall_view.php?res_id=4'" style="cursor: pointer">Find Out More</button>  
		</div>
		<!--img-->
	...
	<section class="reservation">
		...
		<div class="reservation-text">
			...
			<!--details-->
			<p>Enlight your special occasion by finding the best place. You can now search and find the best venue to your weddings, birthday parties and more occasion. We provide you the facility to book it before others.</p>
			<a class="hero-button" href="logged_hall_view.php" >Find Out More</a>
		</div>
		</section>
	<!--End of Hall2-->
