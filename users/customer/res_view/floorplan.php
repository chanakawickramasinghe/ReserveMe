...
<body>
	...
	<div id="content-wrapper">
		...
		<div class="column2">
			...
			<hr>
			<p>Here we have given the opportunity to reserve a table on the preference on them before going to the restaurant. So the customer has to select the number from the floor plan so that they can get there meal at that particular table. It avoids the customer's waiting time at restaurants.</p>
		</div>
